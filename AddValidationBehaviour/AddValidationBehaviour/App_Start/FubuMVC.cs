...
[assembly: WebActivator.PreApplicationStartMethod(typeof(AddValidationBehaviour.App_Start.AppStartFubuMVC), "Start", callAfterGlobalAppStart: true)]

namespace AddValidationBehaviour.App_Start
{
    public static class AppStartFubuMVC
    {
        public static void Start()
        {
            ...
            FubuApplication.For<ConfigureFubuMVC>() // ConfigureFubuMVC is the main FubuRegistry
                ...
                .StructureMapObjectFactory(x => x.AddRegistry<DefaultConventionsRegistry>())
                .Bootstrap();
